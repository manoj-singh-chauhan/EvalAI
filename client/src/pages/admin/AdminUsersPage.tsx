...
// import { FiUsers, FiCheckCircle, FiTrendingUp, FiMoreVertical, FiEye } from 'react-icons/fi';
...
//       <div className="max-w-1250pxl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
//         <div className="mb-8">
//           <h1 className="text-3xl font-bold text-gray-900 mb-2">Users Management</h1>
//           <p className="text-gray-600">View all registered users and their details</p>
//         </div>
...
//                   <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase">Last Seen</th>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20">
      <div className="max-w-1250pxl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-600">View all registered users and their details</p>
        </div>
